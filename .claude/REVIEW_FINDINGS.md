...
### 7.1 ARABIC-ERR-01 — raw English server error strings leak into Arabic toasts/alerts
...
### 7.2 ARABIC-ERR-02 — surfacing sites must adopt `arabicServerError`
...
### 7.3 SCHED-NAV-01 — Schedule tab can't see/book next week
...
### 7.4 WIZARD-PAD-01 — Step-3/4 layout void above the pinned button
